...
```
버전 : X.XX.X
NEXT PATCH * .do 확장자에서 *.dkv 확장자로 변경되었습니다.
NEXT PATCH * 컴파일 성능이 개선되었습니다.
NEXT PATCH * 컴파일러가 경량화 되었습니다.
NEXT PATCH * 간단한 디버깅 기능이 추가되었습니다.
NEXT PATCH * 이제부터 time 모듈이 한글로 지원됩니다.
```
-->
